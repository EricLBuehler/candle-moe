...
fn bench_fused_moe(c: &mut Criterion) {
    // Nomic benchmarks
    run_benchmark_nomic(c, "nomic_seq16_f32", 16, 8, 2, 768, DType::F32);
    run_benchmark_nomic(c, "nomic_seq64_f32", 64, 8, 2, 768, DType::F32);
    run_benchmark_nomic(c, "nomic_seq512_f32", 512, 8, 2, 768, DType::F32);
    run_benchmark_nomic(c, "nomic_seq4096_f32", 4096, 8, 2, 768, DType::F32);
    run_benchmark_nomic(c, "nomic_seq32768_f32", 32768, 8, 2, 256, DType::F32);
    run_benchmark_nomic(c, "nomic_seq16_f16", 16, 8, 2, 768, DType::F16);
    run_benchmark_nomic(c, "nomic_seq64_f16", 64, 8, 2, 768, DType::F16);
    run_benchmark_nomic(c, "nomic_seq4096_f16", 4096, 8, 2, 768, DType::F16);
    run_benchmark_nomic(c, "nomic_seq32768_f16", 32768, 8, 2, 768, DType::F16);
    run_benchmark_nomic(c, "nomic_seq16_bf16", 16, 8, 2, 768, DType::BF16);
    run_benchmark_nomic(c, "nomic_seq64_bf16", 64, 8, 2, 768, DType::BF16);
    run_benchmark_nomic(c, "nomic_seq4096_bf16", 4096, 8, 2, 768, DType::BF16);
    run_benchmark_nomic(c, "nomic_seq32768_bf16", 32768, 8, 2, 768, DType::BF16);

    // Qwen3 benchmarks
    run_benchmark_qwen3(c, "qwen3_seq8_f16", 8, 8, 2, 4096, DType::F16);
    run_benchmark_qwen3(c, "qwen3_seq16_f16", 16, 8, 2, 4096, DType::F16);
    run_benchmark_qwen3(c, "qwen3_seq32_f16", 32, 8, 2, 4096, DType::F16);
    run_benchmark_qwen3(c, "qwen3_8b_seq64_f16", 64, 8, 2, 4096, DType::F16);
    run_benchmark_qwen3(c, "qwen3_8b_seq32768_f16", 32768, 8, 2, 4096, DType::F16);
    run_benchmark_qwen3(c, "qwen3_8b_seq64_bf16", 64, 8, 2, 4096, DType::BF16);
    run_benchmark_qwen3(c, "qwen3_8b_seq32768_bf16", 32768, 8, 2, 4096, DType::BF16);
}
